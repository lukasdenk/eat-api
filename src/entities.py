...
class Label(ApiRepresentable, Enum):
    ...
    WHEAT = {Language.DE: "Weizen", Language.EN: "wheat"}, None
    RYE = {Language.DE: "Roggen", Language.EN: "rye"}, None
    BARLEY = {Language.DE: "Gerste", Language.EN: "barley"}, None
    OAT = {Language.DE: "Hafer", Language.EN: "oat"}, None
    SPELT = {Language.DE: "Dinkel", Language.EN: "spelt"}, None
    HYBRIDS = {Language.DE: "Hybridstämme", Language.EN: "hybrid strains"}, None
    ...
    SOY = {Language.DE: "Soja", Language.EN: "soy"}, None
    MILK = {Language.DE: "Milch", Language.EN: "milk"}, "🥛"
    LACTOSE = {Language.DE: "Laktose", Language.EN: "lactose"}, None
    ALMONDS = {Language.DE: "Mandeln", Language.EN: "almonds"}, None
    HAZELNUTS = {Language.DE: "Haselnüsse", Language.EN: "hazelnuts"}, "🌰"
    WALNUTS = {Language.DE: "Walnüsse", Language.EN: "walnuts"}, None
    CASHEWS = {Language.DE: "Cashewnüsse", Language.EN: "cashews"}, None
    PECAN = {Language.DE: "Pekanüsse", Language.EN: "pecans"}, None
    PISTACHIOES = {Language.DE: "Pistazien", Language.EN: "pistachios"}, None
    MACADAMIA = {Language.DE: "Macadamianüsse", Language.EN: "macadamias"}, None
    CELERY = {Language.DE: "Sellerie", Language.EN: "celery"}, None
    MUSTARD = {Language.DE: "Senf", Language.EN: "mustard"}, None
    SESAME = {Language.DE: "Sesam", Language.EN: "sesame"}, None
    SULPHURS = {Language.DE: "Schwefeldioxid", Language.EN: "sulphurs"}, "🔶"
    SULFITES = {Language.DE: "Sulfite", Language.EN: "sulfites"}, "🔻"
    LUPIN = {Language.DE: "Lupine", Language.EN: "lupin"}, None
    MOLLUSCS = {Language.DE: "Weichtiere", Language.EN: "molluscs"}, "🐙"
    SHELL_FRUITS = {Language.DE: "Schalenfrüchte", Language.EN: "shell fruits"}, None

    BAVARIA = {Language.DE: "Zertifizierte Qualität Bayern", Language.EN: "Certified quality Bavaria"}, "GQB"
    MSC = {Language.DE: "Marine Stewardship Council", Language.EN: "Marine Stewardship Council"}, "MSC"
    ...
    MEAT = {Language.DE: "Fleisch", Language.EN: "meat"}, None
